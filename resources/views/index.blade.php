        ...
        <form action="/add" method="post" class="content">
                ...
                <th class="content_fiex content_fiex-name" name="fullname">お名前<span class="style">※</span></th>
                    <td class="content_fiex-sub">
                        <div class="content-name">
                            <input type="text" class="content_name-sub content_fiex-name" name="fullname" value="">
            ...
            <tr>
                <th class="content_fiex">郵便番号<span class="style">※</span></th>
                    <td class="content_fiex-sub">
                        ...
                        <input type="text" class="content_postcode-sub" name="postcode" pattern="^\d{3}-\d{4}$" id="postcode" value="">
            ...
            <tr>
                <th class="content_fiex">住所<span class="style">※</span></th>
                    <td class="content_fiex-sub">
                        <input type="text" class="content_address-sub" name="address" value="">
            ...
            <tr>
                <th class="content_fiex">建築名</th>
                    <td class="content_fiex-sub">
                        <input type="text" class="content_architecture-sub" name="building_name" value="">
            ...
            <tr>
                <th class="content_fiex">ご意見<span class="style">※</span></th>
                    <td class="content_fiex-sub">
                        <textarea class="content_opinion-sub" name="opinion" maxlength="120" value="" cols="40" rows="10"></textarea>
                    </td>
            </tr>
            </table>
            <p class="content_btn">
